...
function esVerdadero(valor) {
   ...
   // Tu código:
   if (valor) return 'Soy verdadero';   // if (valor ===true)  Es implícito, para que la condición sea leída debe dar true
...
function tieneTresDigitos(num) {
   ...
   // Tu código:
   if (num > 99 && num < 1000) return true;   // (num >=100 && num <=999)
   else return false;
}
